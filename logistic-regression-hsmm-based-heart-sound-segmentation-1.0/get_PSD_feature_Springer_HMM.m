...
% (Octave's signal package may not provide spectrogram; use fallback in that case.)
if exist('OCTAVE_VERSION', 'builtin')
    [~, F, T, P] = spectrogram_octave_fallback(data, sampling_frequency/40, round(sampling_frequency/80), 1:1:round(sampling_frequency/2), sampling_frequency);
else
